...
/**
 * Só a interação vive no cliente. As questões chegam prontas do servidor
 * (veja `page.tsx`), então não há estado de carregamento aqui: o primeiro
 * render — inclusive o do servidor — já mostra a lista inteira.
 */
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredQuestions.map((question, index) => (
                <motion.div
                  ...
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: staggerDelay(index), duration: 0.3 }}
