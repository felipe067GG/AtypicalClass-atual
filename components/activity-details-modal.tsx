      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto bg-gray-950 border-gray-800">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-gray-900/50 p-3 rounded-lg">
              <div className="flex items-center space-x-2 text-blue-400 mb-1">
                ...
                <span className="text-sm font-medium">{t("age") || "Idade"}</span>
              </div>
            ...
            <div className="bg-gray-900/50 p-3 rounded-lg">
              <div className="flex items-center space-x-2 text-blue-400 mb-1">
                ...
                <span className="text-sm font-medium">{t("duration") || "Duração"}</span>
              </div>
            ...
            <div className="bg-gray-900/50 p-3 rounded-lg">
              <div className="flex items-center space-x-2 text-blue-400 mb-1">
                ...
                <span className="text-sm font-medium">{t("rating") || "Avaliação"}</span>
              </div>
            ...
            <div className="bg-gray-900/50 p-3 rounded-lg">
              <div className="flex items-center space-x-2 text-blue-400 mb-1">
                ...
                <span className="text-sm font-medium">{t("downloads") || "Downloads"}</span>
              </div>
          ...
          <div>
            <h4 className="text-lg font-semibold text-white mb-3 flex items-center">
              ...
              {t("objectives") || "Objetivos de Aprendizagem"}
            </h4>
          ...
          <div>
            <h4 className="text-lg font-semibold text-white mb-3 flex items-center">
              ...
              {t("materials") || "Materiais Necessários"}
            </h4>
          ...
          <Tabs defaultValue="steps" className="w-full">
            <TabsList className="grid w-full grid-cols-4 bg-gray-900/50">
              <TabsTrigger value="steps">{t("stepByStep") || "Passo a Passo"}</TabsTrigger>
              <TabsTrigger value="tips">{t("tips") || "Dicas"}</TabsTrigger>
              <TabsTrigger value="variations">{t("variations") || "Variações"}</TabsTrigger>
              <TabsTrigger value="assessment">{t("assessment") || "Avaliação"}</TabsTrigger>
            </TabsList>

            <TabsContent value="steps" className="space-y-4">
              <h4 className="text-lg font-semibold text-white flex items-center">
                <BookOpen className="w-5 h-5 mr-2 text-blue-400" />
                {t("howToImplement") || "Como Implementar"}
              </h4>
            ...
            <TabsContent value="tips" className="space-y-4">
              <h4 className="text-lg font-semibold text-white flex items-center">
                ...
                {t("importantTips") || "Dicas Importantes"}
              </h4>
            ...
            <TabsContent value="variations" className="space-y-4">
              <h4 className="text-lg font-semibold text-white flex items-center">
                <Settings className="w-5 h-5 mr-2 text-blue-400" />
                {t("variationsAndAdaptations") || "Variações e Adaptações"}
              </h4>
              <ul className="space-y-3">
            ...
            <TabsContent value="assessment" className="space-y-4">
              <h4 className="text-lg font-semibold text-white flex items-center">
                <Target className="w-5 h-5 mr-2 text-blue-400" />
                {t("assessProgress") || "Como Avaliar o Progresso"}
              </h4>
              <div className="bg-gray-900/50 p-4 rounded-lg">
                {Array.isArray(activity.assessment) ? (
                  <ul className="space-y-3">
                    {activity.assessment.map((item: string, i: number) => (
                      <li key={i} className="flex items-start space-x-3">
                        <div className="w-2 h-2 bg-blue-500 rounded-full flex-shrink-0 mt-2"></div>
          ...
          <div className="bg-blue-900/20 p-4 rounded-lg border border-blue-500/30">
            <h4 className="text-lg font-semibold text-white mb-2">
              {t("scientificFoundation") || "Fundamentação Científica"}
            </h4>
        ...
        <div className="flex justify-end space-x-3 pt-4 border-t border-gray-800">
          ...
          <Button className="bg-blue-600 hover:bg-blue-700">
            {t("downloadFullMaterial") || "Baixar Material Completo"}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
